...
The services interface definitions are available in the [messageToHash.yaml][messageToHash] file.  
The generated Python Flask server is available in the [python-flask-server] subdirectory.  
